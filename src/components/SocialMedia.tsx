...
export const socialMediaProfiles = [
  { title: 'LinkedIn', href: 'https://www.linkedin.com/company/hestia-labs/', icon: LinkedInIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/hestialabs.io', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/Hestia-Labs', icon: GitHubIcon },
]
